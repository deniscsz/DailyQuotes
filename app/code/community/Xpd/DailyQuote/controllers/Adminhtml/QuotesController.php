...
class Xpd_DailyQuote_Adminhtml_QuotesController extends Mage_Adminhtml_Controller_Action
{
		...
		{
			$fileName   = 'quotes.csv';
			$grid       = $this->getLayout()->createBlock('dailyquote/adminhtml_quotes_grid');
